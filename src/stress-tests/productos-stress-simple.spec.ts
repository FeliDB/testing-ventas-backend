...
const mockProductoService = {
  getProductoService: jest.fn().mockResolvedValue({ data: [], total: 0 }),
  getProductoByIdService: jest.fn().mockResolvedValue({}),
  postProductoService: jest.fn().mockResolvedValue({}),
  putProductoService: jest.fn().mockResolvedValue({}),
  deleteProductoService: jest.fn().mockResolvedValue({}),
};

describe('Productos Stress Test - Simplified', () => {
