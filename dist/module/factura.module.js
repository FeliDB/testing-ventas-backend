...
exports.FacturaModule = FacturaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([factura_entity_1.FacturaEntity, tipoFactura_entity_1.TipoFacturaEntity, metodoPago_entity_1.MetodoPagoEntity])],
        controllers: [factura_controller_1.FacturaController],
        providers: [factura_service_1.FacturaService, factura_repository_1.FacturaRepository],
        exports: [factura_service_1.FacturaService, factura_repository_1.FacturaRepository]
    })
], FacturaModule);
